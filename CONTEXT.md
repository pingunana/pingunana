...
Este contexto reúne os materiais que apresentam a PinguNana a parceiros e acompanham a evolução da presença artística e comercial. Ele existe para manter a linguagem comercial, as métricas e as relações de parceria consistentes.

## Identidade e parceria

**PinguNana**:
A identidade artística e pública da criadora que orienta todos os materiais deste repositório.
_Avoid_: perfil, conta, marca.

**Contato comercial**:
A pessoa responsável por representar a PinguNana em conversas, acordos e recebimentos com parceiros.
_Avoid_: fã, seguidor.

**Parceiro potencial**:
Uma marca, loja, estúdio ou organização elegível que ainda não possui um acordo com a PinguNana.
_Avoid_: cliente, patrocinador.

**Parceria**:
Um acordo de colaboração entre a PinguNana e uma organização, com termos, contrapartidas e responsáveis definidos.
_Avoid_: publi, job.

**Entrega**:
Uma peça de conteúdo ou aparição específica acordada dentro de uma parceria.
_Avoid_: campanha, parceria.

## Materiais e evidências

**Mídia kit**:
Uma apresentação comercial atualizada que explica a identidade artística, audiência, formatos de entrega e evidências de desempenho da PinguNana.
_Avoid_: portfólio, proposta.
...
_Avoid_: fonte de verdade, métrica oficial.
